...
button.addEventListener("click", (e) => {
    input = document.querySelector("#product").value;
    Add(input)
...
function Add(input){
  if(input != ""){
    ...
    newProduct.textContent = input
    output.appendChild(newProduct)
    productArray.push(input);

    // document.getElementsByClassName(".listed_items").innerText=input
    
    
  }else{
    alert("Dont enter a emty box please!!!")
  }
